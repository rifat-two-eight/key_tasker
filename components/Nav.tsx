    ...
    <nav className="fixed w-full z-50 top-0 start-0 border-b border-gray-200 bg-white backdrop-blur-md">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto py-4 px-0">
        ...
        <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
            <Link href="/dashboard" className="text-white focus:ring-4 focus:outline-none font-medium rounded-full text-sm px-10 py-2.5 text-center transition-all hover:scale-105" style={{ background: 'radial-gradient(circle, #33337F, #02024F)' }}>
              Login
            </Link>
